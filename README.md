...
- **✨ LXC AutoScale ML**: Designed for advanced users and more complex environments. This version can be easly extended to fit large automated setups or custom integrations requiring machine-learning-driven autoscaling. It consists of three components: the **API**, the **Monitor**, and the **Model**.
